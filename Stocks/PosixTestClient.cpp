...
//	order.totalQuantity = 1000;
	order.orderType = "MKT";
//	long lotSize = 1000;
	long lotSize = (int)(m_capitalPerStock/closePrice);
...
//			order.totalQuantity = m_totalQuantity[reqId] + lotSize; 
			order.totalQuantity = abs(m_totalQuantity[reqId]) + lotSize; 
//			printf("Since previous signal was: %i, your open positions of total quantity:%li will be squared-off and new position of %li will be craeted.\n", m_signalBuffer[reqId][1], order.totalQuantity, lotSize);  
			cout << "Since previous signal was: " << m_signalBuffer[reqId][1] << "your open positions of total quantity: " << m_totalQuantity[reqId] << "will be squared-off and new position of: " << lotSize << "will be created." << endl;
			m_totalQuantity[reqId] = lotSize;
		}
